package org.rlrio.service.currency.util;
...
public class CurrencyValidator {
    ...
    private final List<String> validCurrencies = Arrays.asList("AED","AFN","ALL","AMD","ANG","AOA","ARS",
            "AUD","AWG","AZN","BAM","BBD","BDT","BGN","BHD","BIF","BMD","BND","BOB","BRL","BSD",
            "BTC","BTN","BWP","BYN","BZD","CAD","CDF","CHF","CLF","CLP","CNH","CNY","COP","CRC",
            "CUC","CUP","CVE","CZK","DJF","DKK","DOP","DZD","EGP","ERN","ETB","EUR","FJD","FKP",
            ...
            "UAH","UGX","USD","UYU","UZS","VES","VND","VUV","WST","XAF","XAG","XAU","XCD","XDR",
            "XOF","XPD","XPF","XPT","YER","ZAR","ZMW","ZWL");

    public boolean isValid(String currency) {
        return validCurrencies.contains(currency.toUpperCase(Locale.ROOT));
    }
}
